...
function Login() {
    ...
    // const handleLogin = async () => {
    //     try {
    //         const response = await axios.post('https://k4knowledgegame.pythonanywhere.com/api/studentsAccount/', {
    //             username: username,
    //             password: password,
    //         });
    ...
    //             const response = await axios.get('https://k4knowledgegame.pythonanywhere.com//api/studentsAccount/protected/', {
    //                 headers: {
            ...
            <div className={cx('contain-login')}>
                ...
                <div className={cx('text-center', 'container-hotline')}>
                    <div>
                        ...
                        <Link to="/KnowledgeGameReactJS/register">Đăng ký</Link>
                    </div>
                    <div>
                        <span>Hotline hỗ trợ: </span>
                        <a href="/KnowledgeGameReactJS/">0836759850</a>
                    </div>
                </div>
            </div>
        </div>
