...
function Questions() {
    ...
    useEffect(() => {
        axios
            .get('https://k4knowledgegame.pythonanywhere.com/api/questionsSubjectAll/')
            .then((res) => {
    ...
    const handleUpdate = async (e) => {
        if (window.confirm(`Bạn có chắc chắn muốn sửa trường dữ liệu ${formData.idQuestion} không?`)) {
            await axios.put('https://k4knowledgegame.pythonanywhere.com/api/questionsSubjectAll/', formData);
        } else {
            e.preventDefault();
        }
    };
    ...
    const handleAdd = async (e) => {
        ...
        await axios.post('https://k4knowledgegame.pythonanywhere.com/api/questionsSubjectAll/', formData);
    };
    return (
        <div>
