...
function Students() {
    ...
    useEffect(() => {
        axios
            .get('https://k4knowledgegame.pythonanywhere.com/api/studentAPIViewByExpiry/')
            .then((res) => {
    ...
    const handleUpdate = async (e) => {
        if (window.confirm(`Bạn có chắc chắn muốn sửa trường dữ liệu ${formData.idAccount} không?`)) {
            await axios.put('https://k4knowledgegame.pythonanywhere.com/api/studentAPIViewByExpiry/', formData);
        } else {
            e.preventDefault();
        }
    };
    ...
    const handleAdd = async (e) => {
        ...
        await axios.post('https://k4knowledgegame.pythonanywhere.com/api/studentAPIViewByExpiry/', formData);
    };
    return (
        <div>
