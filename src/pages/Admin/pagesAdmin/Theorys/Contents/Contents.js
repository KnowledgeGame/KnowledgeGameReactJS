...
function Contents() {
    ...
    useEffect(() => {
        axios
            .get('https://k4knowledgegame.pythonanywhere.com/api/contentSubjectsAll/')
            .then((res) => {
    ...
    const handleUpdate = async (e) => {
        if (window.confirm(`Bạn có chắc chắn muốn sửa trường dữ liệu ${formData.idContentSubject} không?`)) {
            await axios.put('https://k4knowledgegame.pythonanywhere.com/api/contentSubjectsAll/', formData);
        } else {
            e.preventDefault();
        }
    };
    ...
    const handleAdd = async (e) => {
        ...
        await axios.post('https://k4knowledgegame.pythonanywhere.com/api/contentSubjectsAll/', formData);
    };
    return (
        <div>
