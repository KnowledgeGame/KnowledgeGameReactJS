...
function DoExercise() {
    ...
    useEffect(() => {
        axios
            .get(`https://k4knowledgegame.pythonanywhere.com/api/questionsSubjectList/?idCS=${idCS}`)
            .then((res) => {
    ...
    const sendPoint = async () => {
        try {
            ...
            const response = await axios.put('https://k4knowledgegame.pythonanywhere.com/api/studentsAccount/', data);
