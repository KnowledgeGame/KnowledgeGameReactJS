...
function Code() {
    ...
    const sendIdTransactionHistory = async () => {
        try {
            ...
            await axios.put('https://k4knowledgegame.pythonanywhere.com/studentsAccount/', data);
        } catch (error) {
                ...
                <>
                    ...
                    <div className={cx('wrap-option-code', 'd-flex justify-content-center align-items-center')}>
                        ...
                        >
                            ...
                            <span className={cx('title')}>200 K</span>
                            <span className={cx('state')}>Giảm giá</span>
                            <span>Ngày kết thúc: 31/05/2023</span>
                            <span className={cx('initial-price')}>20,000 đ</span>
                            <span className={cx('price-after-discount')}>15,000 đ</span>
                        ...
                        >
                            ...
                            <span className={cx('title')}>2000 K</span>
                            <span className={cx('state')}>Giảm giá</span>
                            <span>Ngày kết thúc: 31/05/2023</span>
                        ...
                        >
                            ...
                            <span className={cx('title')}>10000 K</span>
                            <span className={cx('state')}>Giảm giá</span>
                            <span>Ngày kết thúc: 31/05/2023</span>
