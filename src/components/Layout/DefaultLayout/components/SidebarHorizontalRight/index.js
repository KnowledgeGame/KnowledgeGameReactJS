...
function SidebarHorizontalRight() {
    ...
    useEffect(() => {
        axios
            .get(`https://k4knowledgegame.pythonanywhere.com/api/titleContentList/?nameSubject=${subject}`)
            .then((res) => {
    ...
    useEffect(() => {
        axios
            .get(`https://k4knowledgegame.pythonanywhere.com/api/contentSubjectList/?nameSubject=${subject}`)
            .then((res) => {
    ...
    // useEffect(() => {
    //     axios
    //         .get('https://k4knowledgegame.pythonanywhere.com/api/contentSubjectAndTitleSubject/')
    //         .then((res) => {
